...
namespace MarketEye.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903042818_SavedStrategySharing")]
    partial class SavedStrategySharing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketEye.Domain.Entities.AlertEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("ScreenRunId");

                    b.HasIndex("SavedStrategyId", "DetectedAt");

                    b.ToTable("AlertEvents", (string)null);
                });

            modelBuilder.Entity("MarketEye.Domain.Entities.ApiCallBudget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApiCallBudgets", (string)null);
                });

            modelBuilder.Entity("MarketEye.Domain.Entities.BacktestRebalance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("TurnoverPct")
                        .HasPrecision(18, 6)
                        .HasColumnType("decimal(18,6)");

                    b.HasKey("Id");

                    b.HasIndex("BacktestRunId", "SignalDate");

                    b.ToTable("BacktestRebalances", (string)null);
                });
            ...
            modelBuilder.Entity("MarketEye.Domain.Entities.BacktestRun", b =>
                {
                    ...
                    b.Property<decimal?>("BenchmarkCagr")
                        .HasPrecision(18, 6)
                        .HasColumnType("decimal(18,6)");

                    b.Property<string>("BenchmarkCurveJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal>("CagrGross")
                        .HasPrecision(18, 6)
                        .HasColumnType("decimal(18,6)");

                    b.Property<decimal>("CagrNet")
                        .HasPrecision(18, 6)
                        .HasColumnType("decimal(18,6)");
                    ...
                    b.Property<decimal>("TotalCostsPaid")
                        .HasPrecision(20, 2)
                        .HasColumnType("decimal(20,2)");
            ...
            modelBuilder.Entity("MarketEye.Domain.Entities.BenchmarkPrice", b =>
                {
                    b.Property<string>("Ticker")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.Property<decimal>("TotalReturnIndexValue")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");

                    b.HasKey("Ticker", "Date");

                    b.ToTable("BenchmarkPrices", (string)null);
                });
            ...
            modelBuilder.Entity("MarketEye.Domain.Entities.ScreenRun", b =>
                {
                    ...
                    b.Property<string>("MemberSecuritiesJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MarketEye.Domain.Entities.AlertEvent", b =>
                {
                    ...
                    b.HasOne("MarketEye.Domain.Entities.ScreenRun", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MarketEye.Domain.Entities.BacktestRebalance", b =>
                {
                    b.HasOne("MarketEye.Domain.Entities.BacktestRun", "BacktestRun")
                        .WithMany("Rebalances")
